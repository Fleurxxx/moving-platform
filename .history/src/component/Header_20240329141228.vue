 ...
 * @LastEditTime: 2024-03-29 03:22:52
...
<template>
  <div class="box">
    ...
    >
      ...
      <el-menu-item index="/introduction">关于大会</el-menu-item>
      ...
      <el-menu-item index="/exhibitor">展商风采</el-menu-item>
      <el-menu-item index="/achievement">成果发布</el-menu-item>
      <el-menu-item index="/news">媒体中心</el-menu-item>
      <el-menu-item index="/integral">会议论坛</el-menu-item>
