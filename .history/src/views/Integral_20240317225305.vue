<template>
  <div class="center-container">
    ...
    <div class="title2">
      ...
      <i class="fa-share-alt" style="font-size:1rem;"></i>   
      <font-awesome-icon class="icon" icon="phone" style="font-size:1rem;"/>
    </div>
    <div>
      <el-card style="max-width: 8rem">
        <div v-for="fit in fits" :key="fit" class="block">
          ...
          <div class="lefts">
            <div class="lf_lefts">
              <div class="icons">
                <div class="icons" style="background: #db720f;">
                  <i class="fa fa-share-alt" style="font-size:1rem;color:#ffffff"></i>              
            ...
            <div class="lf_rights"><span data-v-00f0b452="" class="onespan">
              +10% /深夜币
          </span> 
          <el-button type="warning" plain round>去完成</el-button>
          <!-- <el-button type="info" plain round>已完成</el-button> -->
        </div>
      </div>
        </div>
        <el-divider />
