  ...
  <div class="card-container">
    <el-card class="card" v-for="(item, index) in cardList" :key="index">
      ...
      <div class="card_count">
        <CountDown class="card_countdown" :target="targetTime" @on-end="handleEnd" v-font="60" />
      </div>
      <div class="card_but">
        <el-button type="primary" @click="enter">预约直播</el-button>
...
::v-deep .ivu-alert {
  padding: 0.15rem 0.18rem 0.15rem 0.15rem;
}
.card_count{
  position: absolute;
  left: 50%;
