    ...
    <div>
      <el-card style="max-width: 480px">
        <div v-for="fit in fits" :key="fit" class="block">
          <el-avatar  :size="80" :fit="fit" :src="url" />
          <div class="lefts">
            <div class="lf_lefts">
              <div class="icons">
                <div class="icons" style="background: #db720f;">                 
                  <span class="iconfont jifengoumai2" style="font-size:28px;color:#ffffff">
                  </span>               
                </div>
              </div> 
              <div class="nameboxs">
                <p class="coursename">购买课程</p> 
                <p class="pones">购买成功即可<span style="display: none;">（<span class="nums">0</span>/0）</span> <span>（无上限）</span></p>
              </div>
            </div> 
            <div data-v-00f0b452="" class="lf_rights"><span data-v-00f0b452="" class="onespan">
              +10% /深夜币
          </span> 
          <span data-v-00f0b452="" class="twospans">去完成</span> 
          <span data-v-00f0b452="" class="twospans threespan" style="display: none;">已完成</span>
        </div>
      </div>
        </div>
        <el-divider />
...
//每日签到
<div data-v-00f0b452="" class="lefts"><div data-v-00f0b452="" class="lf_lefts"><div data-v-00f0b452="" class="icons"><div class="icons" style="background: #db720f;">                 <span class="iconfont jifengoumai2" style="font-size:28px;color:#ffffff"></span>               </div></div> <div data-v-00f0b452="" class="nameboxs"><p data-v-00f0b452="" class="coursename">购买课程</p> <p data-v-00f0b452="" class="pones">
                                购买成功即可
                                <span data-v-00f0b452="" style="display: none;">（<span data-v-00f0b452="" class="nums">0</span>/0）</span> <span data-v-00f0b452="">（无上限）</span></p></div></div> <div data-v-00f0b452="" class="lf_rights"><span data-v-00f0b452="" class="onespan">
                            +10% /深夜币
                        </span> <span data-v-00f0b452="" class="twospans">
                            去完成
                        </span> <span data-v-00f0b452="" class="twospans threespan" style="display: none;">
                            已完成
                        </span></div></div>
</style>