<template>
  <div class="center-container">
    ...
    <div class="goods-cards">
      <el-card v-for="index in 16" :key="index" class="card" style="max-width: 480px">
        <img
        ...
        <template #footer>
          ...
          <el-button class="goods-cards-but" size="small" type="primary" plain round>库存10jian</el-button>
        </template>
      </el-card>
    </div>
  </div>
