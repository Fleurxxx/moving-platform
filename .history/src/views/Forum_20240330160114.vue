 ...
 * @LastEditTime: 2024-03-30 16:01:13
      ...
      <div class="right">
        <div class="r_sign">
          <el-card v-if="storeUser.signState">
            <h1>已经连续签到&nbsp; {{data.day}} &nbsp;天</h1>
          </el-card>
          <el-button v-else class="r_sign_button" type="primary" size="large">
            <img class="r_sign_img" src="@/assets/image/common/金币.png" @click="enter"/>
            立即签到
          </el-button>
        </div>
