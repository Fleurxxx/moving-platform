        ...
        <Col span="14">
          <el-card class="sing-card">
            <Space class="sign">
              <h3>签到任务</h3>
              <div class="sign-info">
                <span>已经连续签到</span>&nbsp;<span class="pcolor">{{ data.cntTime }}</span>&nbsp;<span>天</span>
              </div>
              <div class="sign-but">
            ...
            <el-table
              ...
              <!-- <el-table-column
                ...
                <el-table-column prop="name" width="200" label="操作" align="left">
                  <template #default="scope">
                    <span class="name-text pcolor">{{scope.row.name}}</span>&nbsp;<span>{{scope.row.things}}</span>
                  </template>
                </el-table-column>
                <el-table-column prop="money" label="金币" align="left" >
                  <template #default="scope">
                    <span class="name-text">+{{scope.row.money}}</span>
                  </template>
                </el-table-column>
