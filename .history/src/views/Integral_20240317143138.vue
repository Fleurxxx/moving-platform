<template>
  <div class="center-container">
    ...
    <div class="goods-cards">
      ...
      <div class="swiper-slide"><div class="topAgendaList active"><div class="top"><div class="tag">平行论坛</div> <div class="tag-date">13:30 - 18:00</div></div> <h1 class="text-overflow2">MSS安全托管运营服务论坛</h1> <div class="bottom"><div class="site"><span class="icon-dizhi iconfont"></span> <span>杭州洲际酒店·国际厅1厅</span></div> <div class="shipin"><span class="icon-icon_video iconfont"></span> <span>观看回放</span></div></div></div></div>
    </div>
  </div>
</template>
