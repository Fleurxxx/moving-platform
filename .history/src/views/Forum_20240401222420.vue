 ...
 * @LastEditTime: 2024-04-01 22:21:10
      ...
      <div class="left">
        ...
        <el-card class="l_discuss" v-for="(item,index) in discussList" :key="index">
          ...
          <el-button-group class="ml-4 l_bottom ">
            ...
            <el-button  :icon="Star" class="flex-item"/><el-icon><Comment /></el-icon>
...
import { Delete, Edit, Search, Share, Star, Upload,Download } from '@element-plus/icons-vue'
