    ...
    <el-card class="card" v-for="(item, index) in cardList" :key="index">
      <el-row>
        ...
        <el-col :span="14" class="card-right">
          ...
          <!-- <span class="card-position"><el-icon :size="15"><Location /></el-icon> {{ item.position }}</span> -->
          <Space class="card-info">
            <Icon type="md-heart-outline" :size="17"/>点赞
            <Icon type="md-heart" :size="17"/>
            <Icon type="md-chatboxes" :size="17"/>
            <!-- <el-icon :size="15"><ChatLineRound />{{ item.comment }}</el-icon>
            <el-icon :size="15"><View />{{ item.view }}</el-icon> -->
          </Space>
