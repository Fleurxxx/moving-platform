 ...
 * @LastEditTime: 2024-04-06 05:50:56
    ...
    <div class="video-box">
      <div class="video-box-left">
        ...
        <div class="title-box">
          ...
          <el-button class="card-but" round><el-icon :size="15"><Plus /></el-icon>{{ "\xa0" }}订阅</el-button>
          <el-button class="card-but" round><el-icon :size="15"><Plus /></el-icon>{{ "\xa0" }}PPT下载</el-button>
        </div>
      </div>
