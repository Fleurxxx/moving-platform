    ...
    <el-dialog v-model="dialogTableVisible" width="800">
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button type="primary" @click="openVIP"> 开通成功 </el-button>
        </div>
      </template>
    </el-dialog>
      ...
      <div class="vip_limit_content">
        <div class="vip_limit_wrap">
          ...
          <div class="vip_limit_close">
            <span class="vip_limit_close_btn">x</span>
          </div>
        </div>
      </div>
    </div> -->
      ...
      let player = new Aliplayer(
        {
          ...
          //   HD: "https://player.alicdn.com/file/official-video/aliyun-sample.m3u8",
          //   SD: "https://player.alicdn.com/file/official-video/aliyun-sample.m3u8",
          // }),
          // cover:
          ...
          components: [
            ...
            // },
            {
              ...
              args: [
                60,
                "#endPreviewTemplate",
                `<a href="https://www.aliyun.com/product/vod" class="vip-join">开通会员</a> 观看完整视频`,
              ],
            },
            // {
            ...
            //   */
            //   args: ['https://player.alicdn.com/resource/player/qupai.mp4', 'https://et.aliyun.com/brain/city', this.videoAdClose, 'VIP关闭广告']
            // },
            // {
