  ...
  <div class="box">
    ...
    <div class="center-container">
      ...
      <div class="goods-cards">
        <el-card v-for="(item,index) in card1" :key="index" class="card" style="max-width: 480px">
          <div class="image-container">
            <img
              :src="item.imghttps://shadow.elemecdn.com/app/element/hamburger.9cf7b091-55e9-11e9-a976-7f4d0b07eef6.png"
            />
          </div>
          <template #footer>
            <h3>小汉堡</h3>
      ...
      <div>
        <el-card class="task_card">
          <div v-for="(fit,index) in fits" :key="fit.id" class="block">
            <div class="lefts">
              <div class="lf_lefts">
                <div class="icons">
            ...
            <div v-if="index !== fits.length - 1 && (index + 1) % 2 === 0" class="c_l"></div>
          </div>
        </el-card>
      </div>
      <div class="title2">
...
const card1 = ref([
  {
    img: 'https://img.yxs.shenyecg.com/Image/35311ebb408e4d259e3232a41a5f8830/n4ZwTp5n4j.jpg',
    num: 500,
  },
  {
    img: 'https://img.yxs.shenyecg.com/Image/35311ebb408e4d259e3232a41a5f8830/n4ZwTp5n4j.jpg',
