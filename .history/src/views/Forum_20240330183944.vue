 ...
 * @LastEditTime: 2024-03-30 18:35:07
  ...
  <div class="box">
    <div class="container">
      <div class="left">
        ...
        <div class="l_discuss">
          <el-card v-for="(item,index) in discussList" :key="index">
            <div>
              <Avatar icon="ios-person" size="large" :src="item.src"/>
              <h2>{{ item.name }}</h2>
              <Time :time="item.time" />
            </div>
            <AvatarList :list="headList" />
          </el-card>
        </div>
      </div>
      <div class="right">
...
const discussList = ref([
  {
    src: require()'https://dev-file.iviewui.com/BbnuuEiM0QXNPHVCvb3E2AFrawIjCkqW/avatar',
