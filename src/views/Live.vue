 ...
 * @LastEditTime: 2024-04-14 00:35:09
  ...
  <div class="center-container">
    <div class="video-box">
      <div class="video-box-left">
        <div class="title-box">
          <h1>格致论道@西湖论剑</h1>
          <el-button class="title-but" round
        ...
        <Video
          ...
          :height="6"
          :url="url"
          v-else-if="storeUser.video === 0"
        />
        <div class="input" v-if="!ban">
          <div class="ali-danmuku-control">
            <div class="danmu-input">
              <input type="text" />
              <button class="danmu-input-enter" @click="banSend">发送</button>
            </div>
      ...
      <div class="video-box-right">
        ...
        <div class="right-timeline">
          <Scroll height="435" :on-reach-bottom="handleReachBottom">
            <el-alert
              title="欢迎来到西湖论剑·数字安全大会直播现场！！！"
              type="info"
              :closable="false"
            />
          </Scroll>
          <el-input
            ...
            placeholder="一起讨论吧~"
          />
          <el-button class="input_button" type="primary">发送</el-button>
        </div>
      </div>
    </div>
    <div class="card-box">
...
const url = ref(
  "http://bo.yangshibo.cn/haha/haha.flv?auth_key=1713021099-0-0-ca4b98ac445c5fbf41ba0620ecf112e4"
);
...
.ali-danmuku-control .player-tooltip.close,
.ali-danmuku-control .player-tooltip.open {
  right: -12px;
}
.player-tooltip {
  position: absolute;
