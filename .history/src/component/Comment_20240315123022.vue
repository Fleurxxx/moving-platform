<template>
    <u-comment :config="config" upload @submit="submit" @like="like" @show-info="showInfo" page @reply-page="replyPage" @operate="operate" ref="commentRef" relative-time>
        <template #card="scope">
            <div class="user-card">
...
import { CommentApi, ConfigApi, useLevel, SubmitParamApi, UToast, createObjectURL,ReplyApi, usePage, ReplyPageParamApi, dayjs, throttle, CommentInstance  } from 'undraw-ui'
