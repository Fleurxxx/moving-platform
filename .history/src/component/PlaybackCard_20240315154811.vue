...
const items2 = ref<Array<Item>>([
  { type: 'primary', label: '全部', mark:1 },
  { type: 'primary', label: '主论坛', mark:1 },
  { type: 'primary', label: '平行论坛', mark:1 },
  { type: 'primary', label: '科普论坛', mark:1 },
  { type: 'primary', label: '掌上论剑', mark:1 },
  { type: 'primary', label: '生态合作论坛', mark:1 },
])
