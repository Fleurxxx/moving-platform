 ...
 * @LastEditTime: 2024-03-29 03:26:49
  ...
  <div class="center-container">
    <div class="video-box">
      <div class="video-box-left">
        ...
        <Video class="video" :width="12" :height="6" :url="" v-else-if="storeUser.video===0"/>
      </div>
...
const data = reactive({})
const url = ref('https://outin-f6c3661ae52711eeaca900163e32a995.oss-cn-shanghai.aliyuncs.com/sv/1204624-18e761b8dde/1204624-18e761b8dde.mp4?Expires=1711699282&OSSAccessKeyId=LTAIxSaOfEzCnBOj&Signature=yFqBgoBnJe3jaAeV%2FHuUBWU23Ag%3D')
