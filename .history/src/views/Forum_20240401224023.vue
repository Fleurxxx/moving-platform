 ...
 * @LastEditTime: 2024-04-01 22:32:11
    ...
    <div class="container">
      <div class="left">
        ...
        <el-card class="l_discuss" v-for="(item,index) in discussList" :key="index">
          ...
          <AvatarList class="l_discuss_likeImg":list="headList" :max="3" :excess-style="excessStyle" />
          <el-button-group class="ml-4 l_bottom ">
            <el-button  :icon="Share" class="flex-item"/>
            <el-button  :icon="Comment" class="flex-item"/>
            <el-button  class="flex-item">
              <i v-if="item.id!=='123' && item.like===false" class="fa fa-thumbs-o-up" ></i>
              <i v-else-if="item.id!=='123' && item.like===true" class="fa fa-thumbs-up" ></i>
              <i v-else-if="item.id!=='123' && item.like===true" class="fa fa-trash-o"></i>
            </el-button>
            <!-- <el-button  :icon="Delete" class="flex-item"/> -->
          </el-button-group>
        </el-card>
      </div>
      <div class="right">
