      ...
      <div class="left">
        ...
        <el-card class="l_discuss" v-for="(item,index) in discussList" :key="index">
          ...
          <el-button-group class="ml-4 l_bottom ">
            <el-button link :icon="Share" class="flex-item"/>
            <el-button link :icon="Comment" class="flex-item"/>
            <el-button links class="flex-item">
              <i v-if="item.id==='123'" class="fa fa-trash-o"></i>
              <i v-else-if="item.id!=='123' && item.like===false" class="fa fa-thumbs-o-up" ></i>
