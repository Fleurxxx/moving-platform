  ...
  methods: {
    ...
    async init() {
        ...
        let player = new Aliplayer({
            ...
            source: this.url,
            source: JSON.stringify({"HD":"https://player.alicdn.com/file/official-video/aliyun-sample.m3u8", "SD":"//player.alicdn.com/video/editor.mp4"}),
            ...
            {   //试看
               ...
               */
              args: [180, '#endPreviewTemplate', '#endPreviewTemplate']
            },
            {
