 ...
 * @LastEditTime: 2024-04-06 05:39:13
    ...
    <div class="video-box">
      <div class="video-box-left">
        ...
        <div class="title-box">
          ...
          <div class="title-info">
            <i class="fa fa-youtube-play">&nbsp;25.2万</i>
            <i class="fa fa-commenting">&nbsp;1728</i>
            <i v-else-if="data.like===false" class="fa fa-thumbs-o-up" >&nbsp;{{ item.likeCnt }}</i>
            <i v-else-if="item.like===true" class="fa fa-thumbs-up" >&nbsp;{{ item.likeCnt }}</i>
            <!-- <span>2023-02-04 22:01:24</span> -->
          </div>
        </div>
      </div>
      <div class="video-box-right">
        ...
        <div class="right-timeline">
          <Scroll height="480" :on-reach-bottom="handleReachBottom">
