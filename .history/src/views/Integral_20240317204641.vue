<template>
  <div class="center-container">
    ...
    <div class="title">
      <h1></h1>
      <img class="little-title" src="@/assets/image/common/金币兑好礼1.png" />
    </div>
    ...
    <div class="title">
      <img class="little-title" src="@/assets/image/common/金币兑周边1.png" />
    </div>
    <div class="goods-cards">
      <el-card v-for="index in 8" :key="index" class="card" style="max-width: 480px">
        <img
      ...
      <div class="scroll-num ax-row"><div class="scroll-num-box"><div class="number"><span data-odometer-final="500" class="num odometer">500</span> <span>+</span></div> <div class="text">
          主题演讲
      </div></div> <div class="scroll-num-box"><div class="number"><span data-odometer-final="550" class="num odometer">550</span> <span>+</span></div> <div class="text">
          合作伙伴
      </div></div> <div class="scroll-num-box"><div class="number"><span data-odometer-final="10000" class="num odometer">10000</span> <span>+</span></div> <div class="text">
          与会嘉宾
      </div></div> <div class="scroll-num-box"><div class="number"><span data-odometer-final="10" class="num odometer">10</span> <span>万+</span></div> <div class="text">
          行业从业者
      </div></div> <div class="scroll-num-box"><div class="number"><span data-odometer-final="2500" class="num odometer">2500</span> <span>万+</span></div> <div class="text">
          直播观看
      </div></div></div>
    </div>
  </div>
