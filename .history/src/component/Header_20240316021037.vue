 ...
 * @LastEditTime: 2024-03-16 02:10:30
...
<template>
  <div class="box">
    ...
    >
      ...
      <el-menu-item index="/integral">积分商城</el-menu-item>{{ "\xa0\xa0\xa0\xa0" }}
      <template v-if="isLoggedIn">
          <Dropdown>
            ...
            <template #list>
                <DropdownMenu>
                    <DropdownItem @click="goToProfile">个人中心</DropdownItem>
                    <DropdownItem @click="goToStore">积分商城</DropdownItem>
        ...
        <template v-else >
          <router-link to="/login">
            <el-icon class="name"><User /></el-icon>{{ "\xa0" }}{{ data.username }}
          </router-link>
      </template>
    </el-menu>
  </div>
