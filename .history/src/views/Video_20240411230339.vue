 ...
 * @LastEditTime: 2024-04-11 23:00:19
    ...
    <div class="video-box">
      <div class="video-box-left">
        ...
        <div class="title-box">
          ...
          <el-button class="title-but" round @click="toggleSubscription" v-if="showSubscription" icon="Plus"><el-icon :size="15"><Plus /></el-icon>{{ "\xa0" }}订阅</el-button>
          <el-button class="title-but" round @click="toggleSubscription" v-else><el-icon :size="17"><Check /></el-icon>{{ "\xa0" }}已订阅</el-button>
          <el-button class="title-but" round><el-icon :size="15"><Download /></el-icon>{{ "\xa0" }}PPT下载</el-button>
        </div>
      </div>
