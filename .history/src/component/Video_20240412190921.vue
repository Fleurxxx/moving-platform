  ...
  methods: {
    ...
    async init() {
        ...
        let player = new Aliplayer({
            ...
            source: this.url,
            source: JSON.stringify({"HD":"https://player.alicdn.com/file/official-video/aliyun-sample.m3u8", "SD":"https://vod.h5video.vip/e7feffa0d46471edbfc00675a0ec0102/multiple.m3u8"}),
