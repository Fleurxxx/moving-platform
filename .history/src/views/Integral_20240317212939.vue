      ...
      <el-card style="max-width: 480px">
        <div v-for="fit in fits" :key="fit" class="block">
          ...
          <div data-v-00f0b452="" class="lefts">
            <div data-v-00f0b452="" class="lf_lefts">
              <div data-v-00f0b452="" class="icons"><div class="icons" style="background: #db720f;">                 <span class="iconfont jifengoumai2" style="font-size:28px;color:#ffffff"></span>               </div></div> <div data-v-00f0b452="" class="nameboxs"><p data-v-00f0b452="" class="coursename">购买课程</p> <p data-v-00f0b452="" class="pones">
                  购买成功即可
