 ...
 * @LastEditTime: 2024-04-11 23:03:49
    ...
    <div class="video-box">
      <div class="video-box-left">
        ...
        <div class="title-box">
          ...
          <el-button class="title-but" round @click="toggleSubscription" v-if="showSubscription" icon="Plus">{{ "\xa0" }}订阅</el-button>
          <el-button class="title-but" round @click="toggleSubscription" v-else icon="Check">{{ "\xa0" }}已订阅</el-button>
          <el-button class="title-but" round icon="Download">{{ "\xa0" }}PPT下载</el-button>
        </div>
      </div>
...
const url = ref('https://outin-f6c3661ae52711eeaca900163e32a995.oss-cn-shanghai.aliyuncs.com/sv/269e0595-18eb295c5e6/269e0595-18eb295c5e6.mp4?Expires=1712920631&OSSAccessKeyId=LTAIxSaOfEzCnBOj&Signature=NegMJ9h35MIQAPKVwmjtlU%2FyY2s%3D');
const timelineItems = [
  {
    center: true,
