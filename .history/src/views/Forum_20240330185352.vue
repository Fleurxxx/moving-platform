 ...
 * @LastEditTime: 2024-03-30 18:50:55
        ...
        <div class="l_discuss">
          <el-card v-for="(item,index) in discussList" :key="index">
            <div class="l_discuss_top">
              ...
              <div cladd="l_discuss_name">
                <h2>{{ item.name }}</h2>
                <Time :time="item.time" />
              </div>
            </div>
            <AvatarList class="l_discuss_likeImg":list="headList" />
          </el-card>
        </div>
      </div>
      <div class="right">
        ...
        <div class="r_advertisement" v-if="visible">
          <el-card class="r_advertisement_card">
